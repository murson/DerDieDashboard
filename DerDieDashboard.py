...
key_endings = 'data/key_endingsv2.pkl'
...
if 'end_except_dict' not in st.session_state:
    st.session_state.end_except_dict = {"e":["yte","bote","see"],"ng":["ang","ing"],"iel":[],"in":["ein"],"er":["tier","pier"],"mus":[],"haus":[],"it":[],"ft":["äft"],"hen":[],"f":["hiff"],"um":["aum"],"rm":["orm"],"em":[],"ik":[],"uch":["buch","tuch"],"tz":["etz"],"ei":["hrei","brei"]}
