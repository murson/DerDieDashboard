...
st.sidebar.subheader("Putting the, 'Fuck Yeah', back into Learning")
st.sidebar.text('Select a barplot (i.e. a gender) to see which endings are associated with that gender in the table below it.')
